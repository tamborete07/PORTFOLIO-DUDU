...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Dez-2024 às 22:26
...
('root', '[{\"db\":\"dudu\",\"table\":\"alunos\"},{\"db\":\"db_agenda\",\"table\":\"agenda\"},{\"db\":\"saep\",\"table\":\"curtida\"},{\"db\":\"saep\",\"table\":\"usuario\"},{\"db\":\"saep\",\"table\":\"publicacao\"},{\"db\":\"saep\",\"table\":\"empresa\"},{\"db\":\"saep\",\"table\":\"comentario\"},{\"db\":\"saep\",\"table\":\"empresa_1\"},{\"db\":\"db_biblioteca\",\"table\":\"livros\"},{\"db\":\"db_biblioteca\",\"table\":\"leitores\"}]');
...
('root', '2024-12-05 21:25:09', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\",\"NavigationWidth\":194}');
...
-- Banco de dados: `saep`
--
CREATE DATABASE IF NOT EXISTS `saep` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `saep`;
